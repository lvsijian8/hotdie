  ...
  <body>
	      ...
	      <div class="blog-masthead">
		      <div class="row">
		      	<div class="col-md-10 col-md-offset-1">
			        <nav class="blog-nav" >
			          <a class="blog-nav-item active" href="index.jsp">首页</a>
			          <a class="blog-nav-item" href="#container">关于项目</a>
			          <!--a class="blog-nav-item" href="#">研究团队</a-->
			          <a class="blog-nav-item" href="item.html">发表项目</a>
			          <a class="blog-nav-item" href="Article.html">发表文章</a>
			          <a class="blog-nav-item" href="Academic.html">学术交流</a>
			          <a class="blog-nav-item" href="#footer">链接</a>
                      <a class="blog-nav-item" href="login.html">登录|注册</a>
			        </nav>
			    	</div>
			    </div>
		    </div>
    ...
    <div class="container" id="container">
      <div class="row">
          ...
          <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
              <div class="panel panel-success">
                ...
                out.println("<li><div class=\"news-title\"><nobr>"+ request.getAttribute("item"+i) +"</nobr></a></div> </li>");
                }
                 %>
        ...
        num--;
                for(int i=num;i>=0;i--){
                out.println("<li><div class=\"news-title\"><nobr>"+ request.getAttribute("word"+i) +"</nobr></a></div> </li>");
                //out.println("<br/>");
                }
                 %>
</ul>
                  ...
                  <!-- <ul class="notification-ul">
                    <li>                      
                      ...
                      <div class="notification-title">
                        ...
                        <nobr>项目启动会将于2016年8月13-14日在中山大学南校区举办</nobr></a>
                      </div>
                    </li>
                    <li>                    
                    ...
                    <li>                    
                      ...
                      <div class="notification-title">
                        ...
                        <nobr>关于进一步规范租赁人员薪酬发放的通知</nobr></a>
                      </div>
                    </li>
                  </ul> -->
                </div><!-- /.panel-body -->
              ...
              <div class="row">
                <div class="col-sm-3 coop1">
                  <img src="pics/cooperators_logo/1.gif" title="中山大学" height="112">
                </div>
                <div class="col-sm-3 coop2">
                  <img src="pics/cooperators_logo/2.jpg" title="中国疾病预防控制中心" height="102">
                </div>
                <div class="col-sm-3 coop3">
                  <img src="pics/cooperators_logo/3.png" title="复旦大学" height="92">
                </div>
                <div class="col-sm-3 coop4">
                  <img src="pics/cooperators_logo/4.jpg" title="南方医科大学" height="110">
                </div>
              </div>              
