...
@WebServlet("/item_write")
public class item_write extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String item = new String(request.getParameter("item").getBytes("ISO8859-1"), "UTF-8");
        String wancheng = new String(request.getParameter("wancheng").getBytes("ISO8859-1"), "UTF-8");
        String sql = "INSERT INTO item (title,item,wancheng,word) VALUES('" + title + "','" + item + "','" + wancheng + "','" + word + "');";
        try {
